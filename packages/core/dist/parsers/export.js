...
function exportVault(payload, options) {
    ...
    switch (options.format) {
        case 'kloak-encrypted': {
            ...
            const { vaultFile } = (0, cipher_js_1.initializeVault)(options.password, exportPayload);
            return {
        ...
        case 'kloak-csv': {
            ...
            const csvData = (0, types_js_1.formatCsv)(headers, rows);
            return {
                format: 'kloak-csv',
                data: csvData,
