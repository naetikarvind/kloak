...
files = [
    ...
    ("OnboardingModels.swift", "Sources/KloakApp/Models/OnboardingModels.swift", "sourcecode.swift"),
    ...
    ("OnboardingAccountConnectSheet.swift", "Sources/KloakApp/Views/OnboardingAccountConnectSheet.swift", "sourcecode.swift"),
    ...
    ("DomainTreeService.swift", "Sources/KloakApp/Services/DomainTreeService.swift", "sourcecode.swift"),
...
print(f"Generated {proj_dir}/project.pbxproj relying solely on AppIcon.icon successfully!")
